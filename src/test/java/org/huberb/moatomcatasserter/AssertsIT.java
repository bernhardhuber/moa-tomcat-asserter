...
import java.io.File;
import org.huberb.moatomcatasserter.MoaTomcatAsserts.MoaAsserts;
import org.huberb.moatomcatasserter.MoaTomcatAsserts.TomcatAsserts;
...
public class AssertsIT {
    ...
    public void testAssertMoaUnzipped() {
        MoaAsserts moaAsserts = new MoaTomcatAsserts.MoaAsserts(moaDir);
    ...
    public void testAssertMoaInstalled() {
        MoaAsserts moaAsserts = new MoaTomcatAsserts.MoaAsserts(moaDir);
        assertTrue(moaAsserts.assertsMoaStartTomcat());
    }

    @Test
    public void testAssertTomcatUnzipped() {
        TomcatAsserts tomcatAsserts = new MoaTomcatAsserts.TomcatAsserts(tomcatDir);
